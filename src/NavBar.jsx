...
<header className="header sticky top-0 shadow-md flex items-center justify-between px-8 py-02 bg-gradient-to-r from-brown-300 to-brown-500">
  <div className="flex text-center text-4xl justify-between">
    ...
    <nav className="nav font-semibold text-lg">
       ...
       <NavLink to='/dashboard' className="p-4 border-b-2 border-violet-500 active:bg-violet-400 active:duration-300 active:font-bold border-opacity-0 hover:border-opacity-100 hover:text-violet-700 duration-200 cursor-pointer">DashBoard</NavLink>
